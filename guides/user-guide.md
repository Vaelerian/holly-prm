...
- Multiple postal addresses, each with an optional label (e.g. "home", "work") and structured fields for line 1, line 2, city, region, postcode, and country
...
On the contact form, use the "+ Add email", "+ Add phone", and "+ Add address" buttons to add as many of each as you need. Labels are free text so you can use whatever convention suits you. On the contact detail page the values become clickable: emails open your mail client, phone numbers your dialler, and addresses open in Google Maps.
